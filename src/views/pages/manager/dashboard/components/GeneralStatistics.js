            ...
            <Grid container spacing={2}>
                <Grid item lg={3} md={6} xs={12}>
                    <div className='card-general-statistic' style={{ backgroundColor: '#1F1498' }}>
                        <p style={{ fontFamily: "'Montserrat', san-serif" }} className='card-general-statistic-data'>{
                            users.length
                        }</p>
                ...
                <Grid item lg={3} md={6} xs={12}>
                    <div className='card-general-statistic' style={{ backgroundColor: '#DE9A27' }}>
                        <p style={{ fontFamily: "'Montserrat', san-serif" }} className='card-general-statistic-data'>{courses ? courses : 'Chưa có khóa học'}</p>
