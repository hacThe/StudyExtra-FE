        ...
        <div style={{ marginTop: '25px' }}>
            <Container maxWidth='false' container spacing={2}>
                <Grid container spacing={2}>
                    {
                        (props.courses.length !== 0) ? props.courses.map((course, num) => {
                            ...
                            <div style={{textAlign: 'center', margin: '20px 0', width:'100%', fontSize:'2rem', fontWeight: '600'}}>Bạn hiện chưa có khóa học nào</div>
                        )
                    }
                </Grid>
            </Container>
