  ...
  function DepositRequest(props) {
    const transactionFormik = useFormik({
      ...
      validationSchema: Yup.object({
        ...
        amount: Yup.number()
          .required("Vui lòng nhập số GEM")
          .positive("Số GEM phải lớn hơn 0"),
      }),
      onSubmit: (values) => {
        console.log(values);
        const transaction = {
        ...
        usersServices.depositRequest(transaction).then(
          (data) => {
    ...
    return (
      <div className="deposit-request">
        ...
        <form
          className="deposit-request-form"
        ...
        >
          <div className="input-item">
            ...
            ></input>
            {transactionFormik.errors.transactionNumber &&
              transactionFormik.touched.transactionNumber && (
          ...
          <div className="input-item">
            ...
            <input
              ...
              onChange={transactionFormik.handleChange}
            ></input>
            {transactionFormik.errors.bankSend &&
              transactionFormik.touched.bankSend && (
                <p className="input-error-validation">
                  {" "}
                  {transactionFormik.errors.bankSend}{" "}
                </p>
          ...
          <div className="input-item">
            ...
            <select
              id="bankReceive"
              value={transactionFormik.values.bankReceive}
              onChange={transactionFormik.handleChange}
            >
