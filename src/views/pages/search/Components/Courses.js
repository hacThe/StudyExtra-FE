        ...
        <div style={{ marginTop: '10px' }}>
            <Container maxWidth={false} container spacing={2}>
                <Grid container spacing={2}>
                    {props.course.length !== 0 ? props.course.map((course, num) => {
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <PaginationOutlined setCurrentPage={setCurrentPage} page={page} index={props.course.length}></PaginationOutlined>
            </div>
        </div>
    );
}
