        ...
        <div className="comment-item">
          {!isEditting ? (
            ...
            <div className="comment-heading">
              <img
                className={
                  comment.isHidden ? "user-avatar gray-scale" : "user-avatar"
                }
                ...
                <div className="comment-manage">
                  ...
                  {!isOpenManageModal ? null : (
                    <div className="comment-modal">
                      ...
                      <div className="modal-item">Báo cáo</div>
                      <div
                        className="modal-item"
                        onClick={() => {
                          setEditting(!isEditting);
            ...
            <div className="comment-editting">
              <div className="comment-editting-heading">
                ...
                <label className="add-img-label" for="editting-image-input">
          ...
          <div className="comment-interact">
            {userInfo &&
            comment.reactions &&
            comment.reactions.includes(userInfo?._id) ? (
              <p
          ...
          {isEditting || !comment.imgUrl ? null : (
            <img className="comment-image" src={comment.imgUrl}></img>
          )}
          {userReplyDisplay == false ? null : (
            <div className="user-reply-comment">
              <div className="user-reply-heading">
                ...
                ></input>
                <label className="add-img-label" for={newIden}>
                  <IoImageOutline size={28} className="add-image-icon" />
                </label>
                <IoSend
                  size={28}
            ...
            <div className="reply">
              {replyDisplay ? (
                <div className="hide-answer">
                  <p className="title" onClick={() => changeReplyDisplay()}>
                    Ẩn câu trả lời
                  </p>
              ...
              {!replyDisplay || comment.replyComment.length == 0
                ? null
