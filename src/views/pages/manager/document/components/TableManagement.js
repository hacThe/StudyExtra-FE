...
const TableManageMent = ({ rowDocs, columnDocs, filter }) => {
  ...
  const editDocument = async () => {
    ...
    navigate(
      `/quan-ly/tai-lieu/chinh-sua/${stringUtils
  ...
  const onCellClick = (params, event) => {
    ...
    if (params.field == "link") {
      dispatch(showToast("success", "Đã sao chép vào bộ nhớ tạm!"));
  ...
  return (
    <div style={{ height: 500, width: "100%" }} className="datagrid-container">
      <DataGrid
