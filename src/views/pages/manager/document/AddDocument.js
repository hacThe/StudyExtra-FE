...
function AddDocument(props) {
  ...
  const addDocument = () => {
    ...
    dispatch(
      documentActions.addNewDocument(data, () => {
        navigate("/quan-ly/tai-lieu");
      })
    );
  };
        ...
        <Grid container className="add-document-container">
          <Grid item xs={12} md={5} lg={5} className="document-info-container">
            ...
            <div className="document-info-item">
              <div className="title">Tên tài liệu</div>
            ...
            <div className="document-info-item">
              <div className="heading-container">
                <div className="title">Doanh mục</div>
                <span
